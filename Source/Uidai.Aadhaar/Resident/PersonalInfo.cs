...
namespace Uidai.Aadhaar.Resident
{
    ...
    {
        /// <summary>
        /// Represents the Pid version.
        /// </summary>
        /// <value>The Pid version.</value>
        public static string PidVersion = "1.0";

        /// <summary>
        /// Represents the Pid XML namespace. This field is read-only.
        /// </summary>
        public static readonly XNamespace PidXmlNamespace = "http://www.uidai.gov.in/authentication/uid-auth-request-data/1.0";
        ...
        public XElement ToXml(string elementName)
        {
            ...
            var personalInfo = new XElement(PidXmlNamespace + elementName,
